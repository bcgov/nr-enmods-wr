...
const config = {
  ...
  KEYCLOAK_URL:
    window.VITE_APP_KEYCLOAK_URL || import.meta.env.VITE_APP_KEYCLOAK_URL,

  KEYCLOAK_REALM:
    window.VITE_APP_KEYCLOAK_REALM || import.meta.env.VITE_APP_KEYCLOAK_REALM,

  COMS_URL: window.VITE_APP_COMS_URL || import.meta.env.VITE_APP_COMS_URL,

  COMS_BUCKET:
    window.VITE_APP_COMS_BUCKET || import.meta.env.VITE_APP_COMS_BUCKET,
}
